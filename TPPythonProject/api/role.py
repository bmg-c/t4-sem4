...
@router.put("/admin/change_role_unsafe", response_model=Inform, status_code=status.HTTP_200_OK)
async def change_role_unsafe(data: ChangeRole):
    return await Role.change_role_unsafe(data)


@router.put("/admin/change_user_block_status", response_model=Inform, status_code=status.HTTP_200_OK)
...
@router.put("/admin/change_product_contents", response_model=Inform, status_code=status.HTTP_200_OK)
...
@router.put("/tutor/change_product_contents", response_model=Inform, status_code=status.HTTP_200_OK)
